...
<div class="col-md-3 product-men">
    <div class="men-pro-item simpleCart_shelfItem">
        ...
        <div class="men-thumb-item">
            <img src="{{url(''.$limit->commodity_image)}}" alt="{{$limit->commodity_title}}" class="pro-image-front" onError="this.src='{{$errorImgUrl}}'">
            <img src="{{url(''.$limit->commodity_image)}}" alt="{{$limit->commodity_title}}" class="pro-image-back" onError="this.src='{{$errorImgUrl}}'">
