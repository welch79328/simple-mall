                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            ...
                            <li class="dropdown menu__item">
                                <a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">商品分類<span class="caret"></span></a>
                                    ...
                                    <div class="agile_inner_drop_nav_info">
                                        ...
                                        <div class="col-sm-4 multi-gd-img">
                                            <ul class="multi-column-dropdown">
                                                ...
                                                <li><a href="{{url('mens')}}">{{$topCate->cate_name}}</a></li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        @endforeach
                            ...
                            <li class=" menu__item"><a class="menu__link" href="#">Q&A</a></li>
                        </ul>
                    </div>
                </div>
            </nav>	
