            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="{{asset($field->art_thumb)}}" alt="" id="art_thumb_img" style="max-height: 100px; max-width: 350px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th>文章內容：</th>
                        <td>
                            <textarea class="ckeditor" name="art_content">{{$field->art_content}}</textarea>
                        </td>
                    </tr>
