...
<div class="banner-bootom-w3-agileits">
    <div class="container">
        ...
        <div class="col-md-3 products-left">
            ...
            <div style="margin-top: 30px" class="col-xs-12">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="minPrice" name="minPrice" placeholder="最小值" required="true">
                    <input type="text" class="form-control" id="maxPrice" name="maxPrice" placeholder="最大值" required="true">
                </div>
                <div>
                    <button type="button" class="btn btn-default" style="width: 100%" onclick="searchGeneralCommodities()">套用</button>
                </div>
                <div>
                    <button type="button" class="btn btn-default" style="width: 100%" onclick="resetPrice()">清除全部</button>
                </div>
            </div>
        ...
        <div class="col-md-9 products-right">
            ...
            <div class="sorting">
                <select id="sortByPrice" onchange="searchGeneralCommodities()" class="frm-field required sect">
...
<script>
    ...
    function searchGeneralCommodities() {
