...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/advertisement/'.$data->advertisement_id)}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        <th>廣告名稱：</th>
                        <td>
                            <input type="text" class="md" name="advertisement_name" value="{{$data->advertisement_name}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>廣告圖：</th>
                        <td>
                            <img src="/{{$data->advertisement_image}}" alt="" id="advertisement_cover_img" style="max-height: 200px; max-width: 350px;">
                            <input type="hidden" id="advertisement_image" size="50" name="advertisement_image" value="{{$data->advertisement_image}}">
    ...
    //                                            data = data.slice(0,29);
                    ...
                    <tr>
                        <th>廣告導連頁：</th>
                        <td>
                            <input type="text" class="lg" name="advertisement_redirect" value="{{$data->advertisement_redirect}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="advertisement_period" value="{{$data->advertisement_start_time}} - {{$data->advertisement_end_time}}">
                    ...
                    <tr>
                        <th>廣告排序：</th>
                        <td>
                            <input type="number" min="1" max="10" style="height: 28px;" name="advertisement_ordering" value="{{$data->advertisement_ordering}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>廣告點數：</th>
                        <td>
                            <input type="number" min="1" style="height: 28px;" name="advertisement_point" value="{{$data->advertisement_point}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>狀態：</th>
                        <td>
                            <input type="radio" name="advertisement_status" value="on" @if($data->advertisement_status == 'on') checked @endif>上架
                            <input type="radio" name="advertisement_status" value="off" @if($data->advertisement_status == 'off') checked @endif>下架
                        </td>
                    </tr>
