            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="advertisement_image" size="50" name="advertisement_image"
                               value="{{$data->advertisement_image}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="advertisement_redirect"
                               value="{{$data->advertisement_redirect}}">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="advertisement_period"
                               value="{{$data->advertisement_start_time}} - {{$data->advertisement_end_time}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" min="1" max="10" style="height: 28px;" name="advertisement_ordering"
                               value="{{$data->advertisement_ordering}}">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" min="1" style="height: 28px;" name="advertisement_point"
                               value="{{$data->advertisement_point}}">
                    </td>
                </tr>
                ...
                <tr>
                    <th>狀態：</th>
                    <td>
                        <input type="radio" name="advertisement_status" value="on"
                               @if($data->advertisement_status == 'on') checked @endif>上架
                        <input type="radio" name="advertisement_status" value="off"
                               @if($data->advertisement_status == 'off') checked @endif>下架
                    </td>
                </tr>
