                ...
                <tr>
                    ...
                    <td>
                        <select name="status">
                            ...
                            <option value="shipping" @if($data->status == 'shipping') selected @endif>出貨中</option>
                            <option value="complete" @if($data->status == 'complete') selected @endif>已送達</option>
                            <option value="refund" @if($data->status == 'refund') selected @endif>退貨處理中</option>
                            <option value="cancel" @if($data->status == 'cancel') selected @endif>取消</option>
                        </select>
                    </td>
                </tr>
