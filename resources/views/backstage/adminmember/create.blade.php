            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        <th>帳號名稱：</th>
                        <td>
                            <input type="text" class="md" name="member_name">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>帳號：</th>
                        <td>
                            <input type="text" class="md" name="member_account">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>密碼：</th>
                        <td>
                            <input type="text" class="md" name="member_password">
                    ...
                    <tr>
                        <th>電子郵件：</th>
                        <td>
                            <input type="text" class="md" name="member_mail">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>手機：</th>
                        <td>
                            <input type="text" class="md" name="member_phone">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>室內電話：</th>
                        <td>
                            <input type="text" class="md" name="member_tel">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>地址：</th>
                        <td>
                            <input type="text" class="md" name="member_location">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="member_level">
                                ...
                                <option value="manage">管理帳號</option>
