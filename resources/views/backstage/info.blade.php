@extends('layouts.backstage.admin')
 ...
 @section('content')
     ...
     <div class="result_wrap">
         ...
         <div class="result_content">
             <ul>
                 <img src="{{asset('uploads/1931.jpg')}}">
                 {{--<li>--}}
                 ...
                 {{--</li>--}}
                 {{--<li>--}}
                     {{--<label>上傳附件限制</label><span><?php echo get_cfg_var("upload_max_filesize")?get_cfg_var("upload_max_filesize"):"" ?></span>--}}
                 {{--</li>--}}
                 {{--<li>--}}
                     {{--<label>時間</label><span><?php echo date('Y-m-d  H:i:s') ?></span>--}}
                 {{--</li>--}}
                 {{--<li>--}}
